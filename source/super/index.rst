...
Tout comme C++ et contrairement à Java, Python est capable d'utiliser l'héritage multiple.
...
*Diamond Problem* est un terme généralement utilisé pour représenter les ambiguïtés survenant
...
La méthode :py:func:`super` va utiliser l'algorithme MRO (Method Resolution Order) afin de déterminer l'ordre
...
.. code-block:: python3
    ...
    # <class 'super_init.C'>, <class 'super_init.A'>, <class 'object'>]
